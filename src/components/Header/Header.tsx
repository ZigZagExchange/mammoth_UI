    ...
    <div className="flex items-center justify-end gap-4 mx-6 my-6">
      ...
      {connected && (
        <Menu as="div" className="relative inline-block text-left">
          ...
          >
            <Menu.Items className="absolute right-0 w-56 mt-2 origin-top-right border divide-y divide-gray-100 rounded-md shadow-lg bg-background-700 border-foreground-400 ring-1 ring-black ring-opacity-5 focus:outline-none">
